...
const MockHeading = ({ level, children, className = '' }: { 
  level: 1 | 2 | 3 | 4 | 5 | 6
...
const MockLabel = ({ children, htmlFor, className = '' }: {
  children: React.ReactNode
  htmlFor?: string
  className?: string
}) => (
...
const MockErrorText = ({ children, className = 'text-red-500 text-sm' }: {
  children: React.ReactNode
  className?: string
}) => (
...
const MockBadge = ({ variant, children }: {
