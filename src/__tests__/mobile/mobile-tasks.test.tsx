...
const MockCreateTaskForm = ({ onCancel, projectOptions, membertOptions }: {
  onCancel: () => void;
...
const MockEditTaskForm = ({ onCancel, initialValues }: {
  onCancel: () => void;
  initialValues: {
    $id: string;
    name: string;
...
describe('Mobile Task Management Tests', () => {
  ...
  describe('Task Editing', () => {
    ...
    it('handles status change on mobile', async () => {
      ...
      fireEvent.touchStart(statusSelect)
      fireEvent.touchEnd(statusSelect)
